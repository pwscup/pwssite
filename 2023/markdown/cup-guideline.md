# PWS Cup セッション実施要領 Ver.0.4
PWS 2023 実行委員会 &ensp;&ensp;&ensp; 2023 年 9 月 27 日公開，2023 年 10 月 30 日更新
...
**場所** &ensp; アクロス福岡 7F CSS 2023 C 会場およびC 会場外ホワイエスペース (ポスター発表)
...
- **掲示には、会場（4階受付）が用意したテープ（両面またはセロハン）を使用してください．それ以外のものによる掲示は禁止します．**

### 掲示場所
- 掲示用ボードは，PWS Cup セッションの会場外ホワイエスペースに設置します．
- **各チームへの掲示用ボードの割り当ては以下の通りです．ご自身のチームIDに対応した掲示用ボードをお使いください．**

![poster-layout](Images/poster-layout.png)

### 掲示期間
- ポスターを掲示する作業は，10 月 30 日 13:40 以降，PWS Cup セッションの「ポスター発表前半」開始前までに行ってください．
...
## 更新履歴
- **Ver.0.4, 2023 年 10 月 24 日．更新．**
- Ver.0.3, 2023 年 10 月 24 日．更新．
