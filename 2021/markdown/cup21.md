...
- 2021/08/18（水） 
    - 参加チーム一覧の追加
    - [ファイルの共有と提出方法について](./Images/docs/README.pdf)の資料、[コンテストデータセットの説明](./Nhanes.html)の追加
    - 予備戦 匿名化フェーズの終了日および提出期限の追記
    - 予備戦レビュー開催時刻の決定と追記
...
## 参加者向け資料
- [ファイルの共有と提出方法について](./Images/docs/README.pdf) （2021/09/13 更新）
...
匿名化フェーズでは削除等の措置を施し、受診者が特定されないようにデータに適切な加工を施してください。  
攻撃フェーズでは、他のチームが加工した匿名ヘルスケアデータに対して、自分のデータが含まれていないかを検査してください。含まれている時は、どのデータかを識別してください。  
...
- 2021/08/19（木） 〜 2021/08/31（火） 予備戦（匿名化フェーズ）
    - __提出締切 2021/08/31（火） 23:59:59 (JST)__
- 2021/09/02（木） 予備戦（攻撃フェーズ）開始
    - __提出締切 2021/09/13（月）昼 11:59:59 (JST)__
- 2021/09/15（水） 予備戦レビュー（振り返り）
    - 17時開始、19時終了予定 @Online
- 2021/09/16（木） 本戦（匿名化フェーズ）開始
    - __提出締切 2021/09/27（月）昼 11:59:59 (JST)__
- 2021/09/30（木） 本戦（攻撃フェーズ）開始
    - __提出締切 2021/10/11（月）昼 11:59:59 (JST)__
