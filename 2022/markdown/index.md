...
### 参加登録
PWS2021への参加登録は、[コンピュータセキュリティシンポジウム2022 (CSS2022)](https://www.iwsec.org/css/2022/) への参加登録と共通となっております (ご登録頂くと、CSS2022 および併催の他のワークショップにも参加が可能です)。
...
#### 発表申込方法
PWS2022への論文投稿受付は、コンピュータセキュリティシンポジウム2022 (CSS2022) への論文投稿受付と共通となっております。
CSS2022の論文募集ページ (https://www.iwsec.org/css/2022/cfp.html) をご覧の上、CSS2022ホームページからお申込ください。
