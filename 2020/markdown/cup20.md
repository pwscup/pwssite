...
- 2020/09/04(金): ルール資料第2版[こちら](./Images/PWSCUP2020_rule_20200904.pdf)を公開しました
    - 変更点は[変更履歴.xlsx](./Images/PWSCUP2020_ルール変更履歴.xlsx)に記載しています。
    - 大きな変更点としては、「有用性指標(分散共分散行列)とutilityFunc.pyの不一致修正」があります
        - utilityFunc.pyに変更はありません。
